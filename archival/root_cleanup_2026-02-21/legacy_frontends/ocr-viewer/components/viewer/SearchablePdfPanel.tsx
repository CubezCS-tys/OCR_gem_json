...
interface SearchablePdfPanelProps {
  docId: string;
  onScroll?: () => void;
}

const SearchablePdfPanel = forwardRef<HTMLDivElement, SearchablePdfPanelProps>(
  function SearchablePdfPanel({ docId, onScroll }, ref) {
    ...
    const scale = htmlZoom / 100;

    return (
      <div className="flex flex-col h-full">
        <PanelHeader title="Searchable PDF">
...
export default SearchablePdfPanel;
